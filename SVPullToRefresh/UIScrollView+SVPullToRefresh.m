...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.textColor = [UIColor colorWithRed:153.0/255 green:153.0/255 blue:153.0/255 alpha:1];;//[UIColor darkGrayColor];
...
- (void)layoutSubviews {
    ...
    titleFrame.origin.x = ceilf(remainingWidth*position+80);
    ...
    arrowFrame.origin.x = ceilf(remainingWidth*position+45);
...
- (UIColor *)arrowColor {
    ...
    return [UIColor colorWithRed:204.0/255 green:204.0/255 blue:204.0/255 alpha:1]; // default Color
}
